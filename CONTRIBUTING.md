...
Open a [GitHub Issue](https://github.com/TheTatu13/aerostar-nodejs-scraper/issues) with:
...
- the company's own careers listing (`https://cariere.aerostar.ro/jobs`) + its job sitemap (``)
- ANOFM (by CIF)
