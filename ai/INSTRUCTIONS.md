...
This scraper extracts job listings for **AEROSTAR SA** (CIF: 950531) from the company's own careers site and from ANOFM, and imports them to peviitor.ro.

Targets: https://cariere.aerostar.ro/jobs, , https://mediere.anofm.ro
...
- **AEROSTAR — listing**: `https://cariere.aerostar.ro/jobs` — pagina publică de posturi deschise (HTML server-rendered)
- **AEROSTAR — sitemap**: `` — permalink-uri canonice `/joburi/<slug>/`
