...
## Description
Scraper automat pentru locurile de muncă AEROSTAR SA (CIF: 950531) — extrage de pe the company careers site și ANOFM, validează via ANAF și publică pe peviitor.ro
...
gh repo edit <owner>/<repo> --add-topic job-seeker-ro-spider --add-topic peviitor-ro \
  ...
  --description "Scraper pentru AEROSTAR SA - peViitor.ro"
