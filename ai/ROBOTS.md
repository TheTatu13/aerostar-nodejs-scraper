...
Fill this in per derived company. Check `https://www.aerostar.com/robots.txt` before the
...
| Path | Role |
|---|---|
| `https://cariere.aerostar.ro/jobs` | Public list of open positions (server-rendered HTML) |
| `` | Job sitemap — canonical `https://cariere.aerostar.ro/jobs/<slug>/` permalinks |
| `https://cariere.aerostar.ro/jobs/<slug>/` | Individual job pages (only referenced, not fully crawled) |
